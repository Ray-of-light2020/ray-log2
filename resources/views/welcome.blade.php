...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 d-block">
                    @auth
            ...
            <div class="pt-5">
                <h1 class="text-center pb-3">非破壊検査 <br>放射線透過試験</h1>
                <h2 class="text-center">ガンマー線 照射条件記録</h2>
            </div>
            <div class="text-center pt-3">
                <span class="search icon"></span>
                <a class="pl-4" href="{{ url('/log') }}">照射条件検索</a>
            </div>
            <div class="text-center pt-3">
                <span class="edit icon"></span>
                <a  class="pl-4" href="{{ url('/log/create') }}">照射条件入力</a>
            </div>
            <div class="text-center pt-3">
            ...
            <div class="text-center pt-5 px-3">
                ...
                <p>現在、編集・削除機能がうまく動作してません。閲覧・入力のみとなっております。</p>
            </div>
            <div class="text-center pt-5 px-3">
                <p>運営者へお問合せ</p>
